...
while True:
    ...
    while True:
        ...
        city_list = ['София', 'Пловдив', 'Варна', 'Бургас', 'Русе', 'Стара Загора', 'Плевен', 'Добрич', 'Сливен',
                     'Шумен', 'Перник', 'Пазарджик', 'Ямбол', 'Хасково', 'Благоевград', 'Велико Търново', 'Враца',
                     'Габрово', 'Асеновград', 'Видин', 'Казанлък', 'Кърджали', 'Кюстендил', 'Монтана', 'Търговище',
                     'Димитровград', 'Силистра', 'Ловеч', 'Дупница', 'Разград', 'Горна Оряховица', 'Свищов', 'Петрич',
                     'Смолян', 'Сандански', 'Самоков', 'Велинград', 'Севлиево', 'Лом', 'Нова Загора', 'Карлово',
                     'Айтос', 'Троян', 'Ботевград', 'Харманли', 'Пещера', 'Гоце Делчев', 'Свиленград', 'Карнобат',
                     'Панагюрище', 'Чирпан', 'Попово', 'Раковски', 'Радомир', 'Първомай', 'Нови Искър', 'Поморие',
                     'Несебър', 'Червен бряг', 'Козлодуй', 'Ихтиман', 'Нови пазар', 'Берковица', 'Раднево', 'Провадия',
                     'Разлог', 'Балчик', 'Бяла Слатина', 'Каварна', 'Костинброд', 'Банкя', 'Стамболийски', 'Етрополе',
                     'Кнежа', 'Левски', 'Павликени', 'Мездра', 'Елхово', 'Тетевен', 'Луковит', 'Тутракан', 'Трявна',
                     'Девня', 'Средец', 'Омуртаг', 'Сопот', 'Исперих', 'Велики Преслав', 'Бяла', 'Ракитово', 'Гълъбово',
                     'Кричим', 'Лясковец', 'Септември', 'Момчилград', 'Банско', 'Белене', 'Аксаково', 'Белослав',
                     'Своге', 'Дряново', 'Любимец', 'Кубрат', 'Пирдоп', 'Елин Пелин', 'Симитли', 'Сливница',
                     'Златоград','Хисаря', 'Дулово', 'Долни чифлик', 'Симеоновград', 'Генерал Тошево', 'Тервел',
                     'Костенец', 'Девин', 'Мадан', 'Стралджа', 'Царево', 'Вършец', 'Твърдица', 'Куклен', 'Бобов дол',
                     'Котел', 'Съединение', 'Елена', 'Оряхово', 'Якоруда', 'Божурище', 'Тополовград', 'Белоградчик',
                     'Стражица', 'Камено', 'Чепеларе', 'Созопол', 'Перущица', 'Суворово', 'Златица', 'Крумовград',
                     'Долна баня', 'Дългопол', 'Ветово', 'Полски Тръмбеш', 'Тръстеник', 'Койнаре', 'Долни Дъбник',
                     'Славяново', 'Годеч', 'Правец', 'Игнатиево', 'Костандово', 'Брацигово', 'Две могили', 'Стрелча',
                     'Неделино', 'Свети Влас', 'Сапарева баня', 'Брезник', 'Смядово', 'Ардино', 'Дебелец', 'Никопол',
                     'Шивачево', 'Белово', 'Цар Калоян', 'Мартен', 'Ивайловград', 'Кресна', 'Върбица', 'Рудозем',
                     'Вълчедръм', 'Приморско', 'Глоджево', 'Летница', 'Мъглиж', 'Искър', 'Шабла', 'Гулянци',
                     'Долна Митрополия', 'Крън', 'Вълчи дол', 'Сливо поле', 'Баня', 'Драгоман', 'Сунгурларе', 'Батак',
                     'Джебел', 'Завет', 'Криводол', 'Мизия', 'Белица', 'Каспичан', 'Кула', 'Николаево', 'Ветрен',
                     'Гурково', 'Роман', 'Калофер', 'Каблешково', 'Априлци', 'Бухово', 'Долна Оряховица', 'Павел баня',
                     'Ябланица', 'Рила', 'Опака', 'Угърчин', 'Златарица', 'Хаджидимово', 'Добринище', 'Обзор',
                     'Бяла черква', 'Дунавци', 'Брегово', 'Трън', 'Садово', 'Килифарево', 'Лъки', 'Малко Търново',
                     'Доспат', 'Копривщица', 'Кочериново', 'Лозница', 'Бяла', 'Борово', 'Черноморец', 'Батановци',
                     'Пордим', 'Ахелой', 'Сухиндол', 'Българово', 'Брезово', 'Главиница', 'Каолиново', 'Чипровци',
                     'Меричлери', 'Земен', 'Плачковци', 'Кермен', 'Момин проход', 'Алфатар', 'Грамада', 'Сеново',
                     'Бойчиновци', 'Антоново', 'Ахтопол', 'Бобошево', 'Шипка', 'Болярово', 'Димово', 'Брусарци',
                     'Китен', 'Клисура', 'Плиска', 'Маджарово', 'Мелник']
